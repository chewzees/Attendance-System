        ...
        <div class="header-content">
            ...
            <nav>
                <ul class="nav-menu">
                    ...
                    <?php else: ?>
                    <li><a href="<?php echo htmlspecialchars(baseUrl('login.php')); ?>"><i class="fas fa-sign-in-alt"></i> Login</a></li>
                    <?php endif; ?>
                </ul>
            </nav>
        </div>
                    ...
                    <div class="grid-2" style="margin-bottom: 0;">
                        ...
                        <div>
                            <div class="form-group">
                                ...
                                <small class="muted">Student ID will be automatically assigned</small>
                            </div>
