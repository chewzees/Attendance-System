    ...
    <main class="dashboard">
        <div class="container">
            ...
            <div class="content-card mt-3">
                ...
                <div class="info-grid">
                    <div class="info-tile">
                        <strong><i class="fas fa-check-circle" style="color: var(--success);"></i> Position Yourself</strong>
                        <span>Face the camera directly and keep your face clearly visible.</span>
                    </div>
                    <div class="info-tile">
                        <strong><i class="fas fa-lightbulb" style="color: var(--warning);"></i> Good Lighting</strong>
                        <span>Use adequate lighting so your face is easy to detect.</span>
                    </div>
                    <div class="info-tile">
                        <strong><i class="fas fa-glasses" style="color: var(--info);"></i> Remove Obstructions</strong>
                        <span>Remove masks, sunglasses, or anything covering your face.</span>
                    </div>
                    <div class="info-tile">
                        <strong><i class="fas fa-smile" style="color: var(--primary);"></i> Stay Still</strong>
                        <span>Keep your head still for a moment while being recognized.</span>
                    </div>
                </div>
            </div>
        </div>
