...
function requireLogin($redirectTo = null) {
    ...
    if (empty($_SESSION['user_id'])) {
        ...
        header('Location: /attendance3/login.php?redirect=' . urlencode($redirect));
        exit;
    }
}
...
function requireRole($roles) {
    ...
    if (!in_array($userRole, $allowed, true)) {
        ...
        echo '<!DOCTYPE html><html><head><title>Access Denied</title>
              <link rel="stylesheet" href="/attendance3/assets/css/style.css"></head>
              ...
              <a href="/attendance3/index.php" class="btn btn-primary">Go to Dashboard</a>
              </div></body></html>';
        exit;
    }
}
