            ...
            <div class="grid-2">
                ...
                <div class="content-card">
                    ...
                    <div class="table-responsive">
                        ...
                        <?php else: ?>
                            <p class="empty-hint">No recent activities</p>
                        <?php endif; ?>
                    </div>
                </div>
                        ...
                        <?php if (!empty($topCourses)): ?>
                            <?php foreach ($topCourses as $course): ?>
                                <div class="list-row">
                                    ...
                                    <small class="muted"><?php echo htmlspecialchars($course['department']); ?></small>
                                </div>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <p class="empty-hint">No courses available</p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="content-card">
                ...
                <div class="info-grid">
                    <div class="info-tile">
                        ...
                        <span><?php echo htmlspecialchars(getSetting('system_version', '2.5')); ?></span>
                    </div>
                    <div class="info-tile">
                        <strong>Recognition Model</strong>
                        <span><?php echo htmlspecialchars(getSetting('face_recognition_model', 'SSD MobileNetV1')); ?></span>
                    </div>
                    <div class="info-tile">
                    ...
                    <div class="info-tile">
                        ...
                        <span><?php echo htmlspecialchars(getCurrentAcademicYear()); ?></span>
                    </div>
                    <div class="info-tile">
                        <strong>Attendance Threshold</strong>
                        <span><?php echo htmlspecialchars(getSetting('minimum_attendance_percentage', 75)); ?>%</span>
                    </div>
                    <div class="info-tile">
                        <strong>Late Threshold</strong>
                        <span><?php echo htmlspecialchars(getSetting('late_threshold_minutes', 15)); ?> minutes</span>
                    </div>
                </div>
            </div>
        </div>
